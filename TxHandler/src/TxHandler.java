...
public class TxHandler {
    ...
    public Transaction[] handleTxs(Transaction[] possibleTxs) {
    	ArrayList<Transaction> currentTxs = new ArrayList<Transaction>();
    	...
    	Transaction[] returnTxs = new Transaction[currentTxs.size()];
    	currentTxs.toArray(returnTxs);
